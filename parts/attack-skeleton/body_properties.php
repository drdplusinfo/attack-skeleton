...
<div class="panel body-properties">
    <div class="panel">
        ...
        <div class="block"><input id="strength" type="number" name="<?= AttackController::STRENGTH ?>" min="-40" max="40"
                                  value="<?= $controller->getCurrentProperties()->getCurrentStrength()->getValue() ?>">
        </div>
    </div>
    <div class="panel">
        <div class="block"><label for="agility">Obratnost</label></div>
        <div class="block"><input id="agility" type="number" name="<?= AttackController::AGILITY ?>" min="-40" max="40"
                                  value="<?= $controller->getCurrentProperties()->getCurrentAgility()->getValue() ?>">
        </div>
    </div>
    <div class="panel">
        <div class="block"><label for="knack">Zručnost</label></div>
        <div class="block"><input id="knack" type="number" name="<?= AttackController::KNACK ?>" min="-40" max="40"
                                  value="<?= $controller->getCurrentProperties()->getCurrentKnack()->getValue() ?>">
        </div>
    </div>
    <div class="panel">
        <div class="block"><label for="will">Vůle</label></div>
        <div class="block"><input id="will" type="number" name="<?= AttackController::WILL ?>" min="-40" max="40"
    ...
    <div class="panel">
        ...
        <div class="block"><input id="size" type="number" name="<?= AttackController::SIZE ?>" min="-10" max="10"
